...
document.addEventListener('DOMContentLoaded', function()
{
	...
	cheet('k a t a b a m i', function()
	{
		alert('I am katabam"e", not katabam"i" you know?');
	});
	cheet('n a t s u k i', function()
	{
		alert("Hmph, I guess you could say it's fancy.");
	});
	cheet('m o n i k a', function()
	{
		alert("Please stop playing with my heart.\nI don't want to come back.")
		document.body.classList.toggle('invert');
	});
	cheet('s a y o r i', function()
	{
		alert('happy thoughts\n\nhappy thoughts\n\nhappy thoughts');
	});
	cheet('y u r i', function()
	{
		alert('ÝťÙÏĐÙÖā¡òŃŃľŦŀĎ¥ĤĈĢ');
	});
});
